...
export class PageNotFoundComponent {
  ...
  // private basket = { x: 250, y: 350, width: 100, height: 15, speed: 60 };
  // private stars: any[] = [];
  // score = 0;
  ...
  // private createStar() {
  //   let star = { x: Math.random() * this.canvas.width, y: 0, radius: 10, speed: 3 + Math.random() * 2 };
  ...
  //   const width = window.innerWidth * 0.5;  // Set canvas width to 90% of the window width
  //   const height = window.innerHeight * 0.5; // Set canvas height to 60% of the window height
